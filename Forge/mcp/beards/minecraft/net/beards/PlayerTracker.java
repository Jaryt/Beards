...
//						}
//						stream.writeInt(1);
//						stream.writeUTF(tag.getString("BeardName"));
//						stream.writeFloat(tag.getFloat("BeardRed"));
//						stream.writeFloat(tag.getFloat("BeardGreen"));
//						stream.writeFloat(tag.getFloat("BeardBlue"));
